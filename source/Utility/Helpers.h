...
const juce::NormalisableRange<int> midiNoteRange {
    12,
    120
}; //actual midi note range is (0,127), but rev2, at least for oscilators is C0(0) to C10(120)
...
{
    juce::FontOptions regular { juce::FontOptions (
        juce::Typeface::createSystemTypefaceFor (BinaryData::PoppinsMedium_ttf, BinaryData::PoppinsMedium_ttfSize)) };
    juce::FontOptions thin { juce::FontOptions (
        juce::Typeface::createSystemTypefaceFor (BinaryData::PoppinsThin_ttf, BinaryData::PoppinsThin_ttfSize)) };
    juce::FontOptions bold { juce::FontOptions (
        juce::Typeface::createSystemTypefaceFor (BinaryData::PoppinsBlack_ttf, BinaryData::PoppinsBlack_ttfSize)) };
